...
def initialize(self = None):
	...
	api1.SetXTwitterHeaders('TwitterStatusUpdaterForExaile', 'http://ravindran.k.googlepages.com/twitter.xml', '0.4')
        api1.PostUpdate("""Twitter Status Updater v0.4 for Exaile http://ravindran.k.googlepages.com/twitterstatusupdaterforexaile """)
